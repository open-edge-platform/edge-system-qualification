...
The Hybrid Edge Computing (HEC) - Edge Microvisor Toolkit (EMT) qualification measures system, display, memory, network, peripheral, and virtualization readiness for hybrid edge deployments on EMT-based systems.
