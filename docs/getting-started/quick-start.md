...
```bash
sudo bash -c "$(wget -qLO - https://raw.githubusercontent.com/open-edge-platform/edge-system-qualification/refs/heads/release/2026.1/scripts/setup-powercap-permissions.sh)"
```
