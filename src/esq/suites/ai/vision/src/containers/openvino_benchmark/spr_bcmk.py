...
import os
import re
import subprocess  # nosec B404 # For OpenVINO benchmark execution (numactl, benchmark_app)
    ...
    try:
        ...
        for _cmd in numa_cmds:
            proc = subprocess.Popen(
                _cmd, text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.DEVNULL
            )
        ...
        print("Execute benchmark app on SPR platform Failed. ")
