...
VIDEO_IN="/home/dlstreamer/sample_video/car_${VIDEO_RESOLUTION}30_10s_${VIDEO_TYPE}.mp4"
VIDEO_OUT="/home/dlstreamer/sample_video/car_${VIDEO_RESOLUTION}30_120s_${VIDEO_TYPE}.mp4"
