...
const updateSectionState = (section: Section): void => {
  ...
  globalThis.sessionStorage.setItem("chosenSection", section);
};
...
export const getSection = () => {
  ...
  const sectionFromLS =
    globalThis.sessionStorage.getItem("chosenSection") === ""
      ? (defaultSectionFromReportOptions || "summary")
      : globalThis.sessionStorage.getItem("chosenSection") || defaultSectionFromReportOptions;
