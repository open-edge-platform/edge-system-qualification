...
class CoreResultsSummaryGenerator:
    ...
    def _collect_system_summary_data(self) -> Dict[str, Any]:
        ...
        try:
            from sysagent.utils.system.formatter import build_display_summary
            ...
            # Use the same conversion as generate_simple_report() for a single source of truth
            summary_hardware, summary_software = build_display_summary(hw_info, sw_info)
            return {"hardware": summary_hardware, "software": summary_software}
