...
class AllureResultsParser:
    ...
    def extract_test_metadata(self, test_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for step in test_result.get("steps", []):
                        ...
                        if att_source:
                            ...
                            if os.path.exists(att_file_path):
                                with open(att_file_path, "r", encoding="utf-8") as f:
                                    ...
                                    # Extract extended_metadata field from Result object
                                    if "extended_metadata" in result_data:
                                        test_extended_metadata.update(result_data["extended_metadata"])
            ...
            if test_metadata_fields or test_metrics or test_extended_metadata:
                break
